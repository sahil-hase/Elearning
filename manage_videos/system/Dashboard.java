...
public class Dashboard extends JFrame implements ActionListener{
    ...
    JButton bookHotel,viewBookedHotel,payments,calculator, notepad,about,logout,deletePersonalDetails;
    String username;
    Dashboard(String username){
        ...
        logout.setBounds(1420,15,100,35);
        ...
        viewPersonalDetails = new JButton("Vied Details");
        ...
        calculator.setBounds(0,595,300,50);
